...
wincmd w
argglobal
if bufexists("router.cpp") | buffer router.cpp | else | edit router.cpp | endif
iabbr <buffer> debugger #ifdef cydiater_debug#endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 42 - ((10 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
...
wincmd w
argglobal
if bufexists("gen.cpp") | buffer gen.cpp | else | edit gen.cpp | endif
iabbr <buffer> debugger #ifdef cydiater_debug#endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
if bufexists("io.cpp") | buffer io.cpp | else | edit io.cpp | endif
iabbr <buffer> debugger #ifdef cydiater_debug#endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
if bufexists("layout.cpp") | buffer layout.cpp | else | edit layout.cpp | endif
iabbr <buffer> debugger #ifdef cydiater_debug#endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
if bufexists("graph.cpp") | buffer graph.cpp | else | edit graph.cpp | endif
iabbr <buffer> debugger #ifdef cydiater_debug#endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
if bufexists("mmcf.cpp") | buffer mmcf.cpp | else | edit mmcf.cpp | endif
iabbr <buffer> debugger #ifdef cydiater_debug#endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
exe 'vert 2resize ' . ((&columns * 88 + 89) / 178)
tabnext 2
badd +1 ../include/router.h
badd +1 router.cpp
badd +0 gen.cpp
badd +45 ../include/gen.h
badd +0 graph.cpp
badd +0 ../include/graph.h
badd +0 mmcf.cpp
badd +1 ../include/mmcf.h
badd +0 layout.cpp
badd +1 ../include/layout.h
badd +8 ~/Lab/MMCF/include/io.h
badd +0 io.cpp
badd +0 makefile
